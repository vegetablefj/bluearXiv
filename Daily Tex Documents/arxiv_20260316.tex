...
\newcommand{\NewestDate}{2026年3月16日}
...
\section{AG}
%AG begin
\arxiv{2603.13198v1}{Jacobian graphs}{Arthur Forey, Javier Fresán, Emmanuel Kowalski 等}

\arxiv{2603.12985v1}{Drawing real plane algebraic curves in OSCAR}{Anne Frühbis-Krüger, Michael Joswig, Lars Kastner}

\arxiv{2603.12623v1}{On Moy-Prasad quotients over Laurent series fields}{David Yang}

\arxiv{2603.12569v1}{Real line subbundles of real bundles on curves}{Daniel A. Santiago Alvarez}

\arxiv{2603.12542v1}{Derived geometric Satake equivalence on the Beilinson-Drinfeld Grassmannian with one leg in mixed characteristic}{Katsuyuki Bando}

%AG end

\section{RT \& QA}
%RT&QA begin
\arxiv{2603.13022v1}{The resolving completion of an exact category}{Marianne Lawson, Janina C. Letz, Julia Sauter}

\arxiv{2603.13006v1}{A characterization of IE-closed subcategories via canonical twin support $τ$-tilting modules}{Hanpeng Gao, Dajun Liu, Yu-zhe Liu}

\arxiv{2603.12974v1}{Derived equivalences and delooping levels}{Liang Chen}
