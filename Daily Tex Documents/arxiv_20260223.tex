...
\newcommand{\AGnumber}{4}
\newcommand{\RTQAnumber}{8}
\newcommand{\NewestDate}{2026年2月23日}
...
\section{AG}
%AG begin
\arxiv{2602.18410v1}{An algebraic theory of Lojasiewicz exponents}{Tai Huy Ha}

\arxiv{2602.18302v1}{Dynamical GCD Problems and a Variant of the Dynamical Mordell-Lang Conjecture}{She Yang, Xiao Zhong}

\arxiv{2602.18102v1}{Degenerations of CoHAs of 2-Calabi-Yau categories}{Lucien Hennecart, Shivang Jindal}

\arxiv{2602.17927v1}{Cohomological boundedness of twisted coherent Springer sheaves}{Oron Y. Propp}

%AG end

\section{RT \& QA}
%RT&QA begin
\arxiv{2602.18341v1}{Torsion pairs via cosilting mutation}{Lidia Angeleri Hügel}

\arxiv{2602.18102v1}{Degenerations of CoHAs of 2-Calabi-Yau categories}{Lucien Hennecart, Shivang Jindal}

\arxiv{2602.17927v1}{Cohomological boundedness of twisted coherent Springer sheaves}{Oron Y. Propp}

\arxiv{2602.18361v1}{Quantum relations in the general setting: composition and adjacency operators}{Matthew Daws}

\arxiv{2602.18275v1}{$(\mathfrak{gl}_{n},\mathfrak{gl}_{m})$-duality and Olshanski homomorphism}{B. Feigin, L. Rybnikov, F. Uvarov}

\arxiv{2602.18204v1}{Twisted symmetric exclusion processes and set-theoretical $R$-matrices}{Mathieu Dabrowski, Loïc Poulain d'Andecy, Eric Ragoucy}

\arxiv{2602.18129v1}{Stuck Knots: Rigidity, Invariants, and Unsticking Distance}{Ioannis Diamantis}
